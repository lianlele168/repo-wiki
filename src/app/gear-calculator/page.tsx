...
import { UPGRADE_ITEMS } from '@/data/wikiData';
...
export const metadata = {
  ...
  description: "Real R.E.P.O. service-station upgrades ranked by community priority — Stamina, Max Health, Strength, and more, with verified effects.",
};
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <span className="text-xs text-slate-500 uppercase tracking-wider">Service Station Upgrade</span>
                  </div>
                  <span className="text-lg font-extrabold font-mono text-amber-400">{gear.priority}</span>
                </div>
              ...
              <div className="space-y-3 pt-4 border-t border-slate-800/80">
                ...
                <div className="flex justify-between items-center text-xs font-mono">
                  ...
                  <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold border ${
                    gear.priority === 'Core' ? 'bg-emerald-500/20 text-emerald-300 border-emerald-500/40' :
                    gear.priority === 'Strong' ? 'bg-amber-500/20 text-amber-300 border-amber-500/40' :
